            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="card blog blog-detail border-0 shadow rounded">
                        <img src="{{ asset('image/blog/'.$data->image) }}" width="100%" class="img-fluid rounded-top" alt="">
                        <div class="card-body content" onmousedown='return false;' onselectstart='return false;'>
