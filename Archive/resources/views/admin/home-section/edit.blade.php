  ...
  <div class="content-wrapper">
      <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Home Section Update</h4>
              <p class="card-description">
                complete form for update home section #{{ $data->id }}
              </p>
              <form class="forms-sample" method="post" action="{{ route('home_section_update', $data->id) }}" enctype="multipart/form-data">
                @csrf
